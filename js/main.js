...
const i18n = {
  fr: {
    ...
    'nav-offers':  'Offres',
    'nav-about':   'À propos',
    'topbar-msg':  '<i class="fa-solid fa-pen-nib me-2"></i>Cabinets, institutions et professions du conseil — je structure votre autorité éditoriale.',
    'topbar-cta':  'Prendre un premier échange →',

    'hero-badge':  'Cabinets · Institutions · PME · Professions du conseil',
    'hero-title':  'Je transforme l\'expertise des cabinets et institutions en <span class="text-accent">autorité éditoriale reconnue</span>.',
    'hero-lead':   'Production de contenu éditorial d\'expertise et conseil en stratégie éditoriale pour les acteurs de la finance, du droit et du conseil. Parce que la crédibilité ne s\'improvise pas — elle se construit avec méthode.',
    ...
    'off1-price':  '<i class="fa-solid fa-tag me-2"></i>À partir de 9 000 DH',
  ...
  ar: {
    ...
    'off1-price':  '<i class="fa-solid fa-tag me-2"></i>ابتداءً من 9 000 درهم',
