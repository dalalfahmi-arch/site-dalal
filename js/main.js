...
const i18n = {
  fr: {
    ...
    'off1-title':  'Audit Stratégique',
    'off2-title':  'Structuration Éditoriale',
    'off3-title':  'Accompagnement de Positionnement',
    'off1-for':    'Beaucoup de clubs, PME et cabinets publient régulièrement sans réellement renforcer leur crédibilité, attirer des opportunités ou structurer leur image. L\'audit stratégique permet d\'identifier précisément ce qui fragilise votre positionnement, ce qui brouille votre message, et ce qui empêche votre communication de produire un impact concret.',
  ...
  ar: {
    ...
    'off1-title':  'التدقيق الاستراتيجي',
    'off2-title':  'البنية التحريرية',
    'off3-title':  'مرافقة التموضع',
    'off1-for':    'كثير من الأندية والمؤسسات الصغيرة والمكاتب تنشر بانتظام دون أن تعزز مصداقيتها فعلياً، أو تجذب فرصاً، أو تبني صورة متماسكة. يتيح التدقيق الاستراتيجي تحديد ما يُضعف تموضعكم، وما يُشوّش رسالتكم، وما يحول دون أن يُحدث تواصلكم أثراً حقيقياً.',
