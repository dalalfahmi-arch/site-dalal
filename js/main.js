...
const i18n = {
  fr: {
    ...
    'hero-title':  'Je transforme l\'expertise des cabinets et PME en <span class="text-accent">contenu qui fait autorité</span>.',
    'hero-lead':   'Production de contenu éditorial d\'expertise et conseil en stratégie éditoriale pour les cabinets, PME et professions du conseil dans la finance, le droit et le business. Parce que la crédibilité ne s\'improvise pas — elle se construit avec méthode.',
