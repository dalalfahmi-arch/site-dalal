...
const i18n = {
  fr: {
    ...
    'abt1-desc':   'Votre communication ne doit pas seulement être visible. Elle doit être perçue comme crédible, structurée et maîtrisée.',
    'abt2-desc':   'Ce qui fonctionne sur les marchés internationaux ne fonctionne pas toujours au Maroc. Votre communication doit parler aux réalités locales tout en conservant un niveau institutionnel élevé.',
    'abt3-desc':   'Votre image doit rester cohérente entre vos différentes audiences, partenaires et prises de parole — en français comme en arabe.',
  ...
  ar: {
    ...
    'abt1-desc':   'لا يكفي أن يكون تواصلكم مرئياً. يجب أن يُدرَك باعتباره موثوقاً وبنيوياً ومُتحكَّماً فيه.',
    'abt2-desc':   'ما ينجح في الأسواق الدولية لا ينجح دائماً في المغرب. يجب أن يخاطب تواصلكم الواقع المحلي مع الحفاظ على مستوى مؤسسي رفيع.',
    'abt3-desc':   'يجب أن تبقى صورتكم متماسكة بين مختلف جماهيركم وشركائكم وتدخلاتكم العلنية — بالفرنسية كما بالعربية.',
