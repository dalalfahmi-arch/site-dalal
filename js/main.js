...
const i18n = {
  fr: {
    ...
    'off1-title':  'Audit Stratégique Digital &amp; Éditorial',
    'off2-title':  'Structuration Éditoriale',
    'off3-title':  'Accompagnement de Positionnement',
    'off1-for':    'Publier sans stratégie, c\'est dépenser de l\'énergie sans retour. La plupart des clubs, PME et cabinets alimentent leurs réseaux régulièrement — sans impact mesurable sur leur crédibilité, leur attractivité commerciale ou leur autorité sectorielle. L\'audit stratégique vous dit exactement ce qui ne fonctionne pas — et comment y remédier.',
    'off2-for':    'Vous publiez, mais vos contenus ne renforcent pas votre expertise. Ils ne positionnent pas votre structure comme référence dans votre domaine. La structuration éditoriale met fin à l\'improvisation : elle vous donne une ligne directrice claire, des formats récurrents et un calendrier maîtrisé.',
    'off3-for':    'Votre expertise est réelle, mais votre communication ne la reflète pas. Vous êtes perçu comme un acteur parmi d\'autres — pas comme une référence. L\'accompagnement de positionnement corrige cet écart : il vous donne les outils pour affirmer votre différenciation et occuper un territoire éditorial distinct.',
    ...
    'abt1-desc':   'La plupart des prestataires pensent en termes de formats, de fréquence et d\'algorithmes. Ce qui détermine réellement votre crédibilité, c\'est la cohérence de votre discours, la clarté de votre positionnement et la maîtrise de votre ligne éditoriale. C\'est ce regard — celui d\'une éditrice formée à l\'exigence du média de prestige — que vous obtenez.',
    ...
    'stat3-lbl':   'Clubs sportifs en pleine transformation (Coupe du Monde 2030), PME cherchant à structurer leur image, cabinets voulant s\'imposer comme références — ces enjeux demandent une expertise de terrain, pas une méthode générique importée.',
    ...
    'diag-sub':    'Beaucoup d\'organisations investissent dans la communication avant d\'avoir une lecture claire de leur situation. Cette session existe pour corriger cela : 60 minutes pour voir précisément où vous en êtes — et quoi faire ensuite.',
    'deliv1':      'Une lecture nette de ce qui fragilise votre positionnement actuel',
    'deliv2':      'L\'identification des priorités à corriger — classées par impact, pas par urgence ressentie',
    'deliv3':      'Un premier plan d\'action orienté résultats — pas de jargon, pas de rapport théorique',
  ...
  ar: {
    ...
    'off1-title':  'التدقيق الاستراتيجي الرقمي والتحريري',
    'off2-title':  'البنية التحريرية',
    'off3-title':  'مرافقة التموضع',
    'off1-for':    'النشر بلا استراتيجية هو استنزاف للطاقة دون عائد. تغذي معظم الأندية والمؤسسات الصغيرة والمكاتب شبكاتها بانتظام — دون أثر قابل للقياس على مصداقيتها أو جاذبيتها التجارية أو سلطتها القطاعية. يخبركم التدقيق الاستراتيجي بدقة ما لا يعمل — وكيف معالجته.',
    ...
    'stat3-lbl':   'أندية رياضية في خضم التحوّل (كأس العالم 2030)، مقاولات صغيرة ومتوسطة تسعى لهيكلة صورتها، مكاتب تريد أن تُفرض كمراجع — هذه التحديات تستدعي خبرة ميدانية، لا منهجية مستوردة.',
