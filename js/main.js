...
const i18n = {
  ...
  ar: {
    ...
    'off1-price':  '<i class="fa-solid fa-tag me-2"></i>ابتداءً من <bdi>7&nbsp;000 DH</bdi>',
    ...
    'faq4-q':   'لماذا <bdi>7&nbsp;000 DH</bdi> مقابل تشخيص؟',
    ...
    'faq5-q':   'هل تعملين بالفرنسية أيضاً؟',
    'faq5-a':   'نعم، وبمستوى تحريري حقيقي. كثير من المؤسسات لديها تواصل عربي متين وتواصل فرنسي مُهمَل، أو العكس؛ هذا التفاوت يبعث إشارة هشاشة. أشتغل على المستويين <strong>بالصرامة نفسها</strong>، حتى يبقى خطابك منسجماً مهما كانت لغة مُحاوِرك.'
  }
};
